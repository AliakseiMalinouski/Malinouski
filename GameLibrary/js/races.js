       ...
       // создаём элементы
        ...
        document.addEventListener('keydown', function (EO) {
            ...
            if (auto.offsetLeft < 50) {
                ...
                alertGameOver.innerHTML = 'GAME OVER.' + '<br>' + '<br>' + 'Your record: ' + '<br>' + '<br>' + '<span style="color: lime; font-size: 25px; text-decoration: underline;">' + resultsScore + '</span>';
        ...
        function crashYellowCar() {
            if (!rect3Rect(box3, box4)) {
                setTimeout(function () {
                    crashYellowCar();
                }, 50);
            }
        ...
        function crashRedCar() {
            if (!rect4Rect(box5, box6)) {
                setTimeout(function () {
                    crashRedCar();
                }, 50);
            }
